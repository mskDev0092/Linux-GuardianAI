...
2. Make it executable:
   ```bash
   chmod +x GuardianAI_0.0.6_amd64.AppImage
   ```
3. Run it:
   ```bash
   ./GuardianAI_0.0.6_amd64.AppImage
   ```
...
2. Install using `apt` (handles dependencies automatically):
   ```bash
   sudo apt install ./GuardianAI_0.0.6_amd64.deb
   ```
3. Alternatively, use `dpkg`:
   ```bash
   sudo dpkg -i GuardianAI_0.0.6_amd64.deb
